...
| ![Duke](/images/Coursera_duke.png "Programming Fundamentals"){: width="px"} | ![Umich](/images/Coursera_umich.png "Introduction to Data Science in Python"){: width="px"} | ![Upenn](/images/Coursera_upenn.png "Entrepreneurship"){: width="1800px"} |
|:---:|:---:|:---:|
